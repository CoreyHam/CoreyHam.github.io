                        ...
                        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            ...
                            <blockquote className="relative p-8 mb-4">
                                ...
                                <p className="text-md font-light mt-2 text-gray-600">
                                    The Saturn University website features a user-friendly design that captures the essence of a fictional academic institution nestled among Saturn's rings. This project is still being worked on.
                                </p>
                            </blockquote>
                            <div className="flex justify-evenly py-2 text-lg font-bold" >
                                <a className="p-4 hover:text-red-700" href="https://coreyham.github.io/university/">Live Demo</a>
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            ...
                            <blockquote className="relative p-8 mb-4">
                                ...
                                <p className="text-md font-light mt-2 text-gray-600">
                                    The to-do project was a coding challenge where I created a fully interactive to-do list while learning React. This project took me one week.
                                </p>
                            </blockquote>
                            <div className="flex justify-evenly py-2 text-lg font-bold" >
                                <a className="p-4 hover:text-red-700" href="https://coreyham.github.io/to-do/">Live Demo</a>
                                <a className="p-4 hover:text-red-700" href="https://github.com/CoreyHam/to-do">GitHub <i class="fa-brands fa-github" ></i> </a>
